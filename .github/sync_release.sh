...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Vectrex_MiSTer.git"
CORE_NAME=(Vectrex)
...
UPSTREAM_CORE_NAME=(Vectrex)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Vectrex.qpf)
COMPILATION_OUTPUT=(output_files/Vectrex.rbf)
